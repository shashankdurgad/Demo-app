# Automated OTEL PR — Audit Gaps (Part 1)
...
**Part 2** (later auto-PR round, after export/scoring mostly worked): [`otel-pr-audit-gaps-part-2.md`](./otel-pr-audit-gaps-part-2.md)
...
See also Part 2 checklist additions in [`otel-pr-audit-gaps-part-2.md`](./otel-pr-audit-gaps-part-2.md).
...
- Trace `1daceb18…` (manual-fix branch): `entry_point` + `llm_call`, `two_layer=true`, live scores 1.0.
